...
public class Elevator implements AutoCloseable {
    ...
    private final Encoder m_encoder = new Encoder(ElevatorConstants.kEncoderAChannel,
            ElevatorConstants.kEncoderBChannel);

    private final PWMSparkMax m_motor = new PWMSparkMax(ElevatorConstants.kLeaderMotorPort);
