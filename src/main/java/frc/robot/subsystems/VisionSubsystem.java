...
/**
 * A modified version of an example PhotonVision class taken from:
...
public class VisionSubsystem extends SubsystemBase {
    ...
    private VisionStrategy m_strategy = VisionStrategy.ESTIMATE_POSE;
     ...
     *
     * @param swerveDrive Swerve Drive class representing and controlling the swerve
     *                    drive.
     */
    ...
    public void updatePoseEstimation() {
        if (SwerveDriveTelemetry.isSimulation && m_swerveDrive.getSimulationDriveTrainPose().isPresent()) {
            /*
